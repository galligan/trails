export declare function getDb(dbPath?: string): import("drizzle-orm/better-sqlite3").BetterSQLite3Database<{
    ...
    notes: import("drizzle-orm/sqlite-core").SQLiteTableWithColumns<{
        name: "notes";
        schema: undefined;
        columns: {
            id: import("drizzle-orm/sqlite-core").SQLiteColumn<{
...
export declare function setupDatabase(dbPath?: string): Promise<import("drizzle-orm/better-sqlite3").BetterSQLite3Database<{
    users: import("drizzle-orm/sqlite-core").SQLiteTableWithColumns<{
        name: "users";
        schema: undefined;
        columns: {
