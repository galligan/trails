/**
 * Base error class for all Fieldbooks errors
 *
 ...
 */
export class FieldbooksError extends Error {
  /**
 ...
 */
export class FieldbooksValidationError extends FieldbooksError {
  /**
   * @param message - Human-readable error message
  ...
  constructor(
    ...
    super(message);
    this.name = 'FieldbooksValidationError';
  }
}
 ...
 */
export class FieldbooksDbError extends FieldbooksError {
  /**
   * @param message - Human-readable error message
