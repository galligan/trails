 ...
 */
export function getGlobalLogbookDir(): string {
 ...
 */
export async function findLogbookDir(startDir: string = process.cwd()): Promise<string | null> {
 ...
 */
export async function getLogbookDir(options?: LogbookPathOptions): Promise<string> {
 ...
 */
export async function getLogbookDbPath(options?: LogbookPathOptions): Promise<string> {
 ...
 */
export async function getLogbookConfigPath(options?: LogbookPathOptions): Promise<string> {
  const dir = await getLogbookDir(options);
 ...
 */
export async function getLogbookLocalConfigPath(options?: LogbookPathOptions): Promise<string> {
  const dir = await getLogbookDir(options);
 ...
 */
export async function initLogbookDir(options?: LogbookPathOptions): Promise<string> {
  const dir = await getLogbookDir(options);
  ensureDirectory(dir);
